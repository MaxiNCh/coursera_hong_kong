				...
				<div className="row row-content">
					...
					<div className="col-12 col-sm-11 offset-sm-1">
						<div className="btn-group" role="group">
							<a role="button" className="btn btn-info" href="tel:+85212345678"><i className="fa fa-phone"></i> Call</a>
							<a role="button" className="btn btn-primary text-white" href="/"><i className="fa fa-skype"></i> Skype</a>
								...
								<Col md={10}>
									...
									<Errors className="text-danger"
										...
										messages={{
											...
											minLength: "Should be more than 2 characters",
											maxLength: "Should be no more than 15 characters",
											isNumber: "Should contain only digits"
										}}
									/>
								</Col>
							</Row>
